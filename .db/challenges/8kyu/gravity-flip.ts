...
function flip(d: string, a: number[]): number[] {
  // your code here
}

test(flip("R", [3, 2, 1, 2]), [1, 2, 2, 3]);
test(flip("L", [1, 4, 5, 3, 5]), [5, 5, 4, 3, 1]);
test(flip("R", [1, 2, 3]), [1, 2, 3]);
test(flip("L", [3, 2, 1]), [3, 2, 1]);
test(flip("R", [5, 1, 3]), [1, 3, 5]);

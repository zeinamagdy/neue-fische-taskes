...
function queueTime(customers: number[], registers: number): number {
  // your code here
}

test(queueTime([5, 3, 4], 1), 12);
test(queueTime([10, 2, 3, 3], 2), 10);
test(queueTime([], 1), 0);
test(queueTime([2, 3, 10], 2), 12);
test(queueTime([1, 2, 3, 4, 5], 5), 5);
